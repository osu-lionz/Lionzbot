				...
				.then(function (mapinfo) {
					...
					.then(async function (compareinfo) {
						...
						const embed = new MessageEmbed()
							.setColor('#B65FCF')
							.setAuthor({ name: `Top osu!${modetext} plays for ${playerinfo.data.player.info.name} on ${compareinfo.data.scores[0].beatmap.title} - ${compareinfo.data.scores[0].beatmap.version}`, iconURL: `https://a.leeuwz.nl/${playerinfo.data.player.info.id}`, url: `https://osu.ppy.sh/b/${compareinfo.data.scores[0].beatmap.id}`})
